            ...
            <form id="formTambahImunisasi">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="callout callout-warning">
                            <p>Jika nama balita tidak ada, tambahkan data balita dengan klik tombol
                                <b>"Tambah Data Balita"</b>
                            </p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="card card-outline card-success shadow-sm">
                            <div class="card-header bg-default">
                                <h3 class="card-title mt-2">Data Imunisasi</h3>
                        ...
                        $.each(imunisasi, function(indexInArray, valueOfElement) {
                            ...
                            if (indexInArray != 'id' && indexInArray != 'created_at' &&
                                ...
                                if (valueOfElement != null) {
                                    ...
                                    $("#" + indexInArray).attr('disabled', true);
                                } else {
                                    document.getElementById(indexInArray).checked = false;
                                    $("#" + indexInArray).attr('disabled', false);
                                }
                            }
                        });
                    } else {
